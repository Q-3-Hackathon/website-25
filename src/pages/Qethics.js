...
function Qethics() {
  return (
    <div>
      <h1>Q^3 Initiative<br/>QETHICS @ USC</h1>
      <p>September 12 - 14, 2025 | University of Southern California, TBD</p>
      <p>At USC, Q^3 will focus on two pillars: ethics and engineering. With the help of sponsors, we aim to provide quantum workshops, 
      ...
      <Link to={"/QEE"}>Insert Arrow Here</Link>
      <h3>Schedule</h3>
