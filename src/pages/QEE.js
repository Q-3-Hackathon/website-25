...
function QEE() {
    return (
      <div>
        ...
        <h2>Lecture(s) on Introduction to Quantum Computing</h2>
        <p>All lectures will also be recorded and live streamed on Zoom!
        Release IBM Q labs now and allow students 1-2 weeks to prepare</p>
        <h3>Lecture 1 - 3/25/2025: What is quantum computing?</h3>
        <p> By Eli Levenson-Falk EEB132 and Zoom from 2:30 - 3:30 pm</p>
        <h3>Lecture 2 - 4/1/2025: More on Quantum Computing</h3>
        <p>By Brennen Rudd EEB132 from 2-30 - 3:30 pm</p>
        <h3>Lecture 3 - 4/8/2025: SQuADDS Workshop</h3>
        <p>with Sadman Ahmad Shanto SSC110 from 2:30 - 3:30 pm</p>
        <h2>Lab sessions and office hours</h2>
        <p>With the help of graduate students in the QISE MS or PhD program, we will facilitate ‘office hours’ where students can ask questions about the labs and get help with learning any material covered in the lectures or labs. </p>
        <p>Session 1 - 4/14/2025: Lab/office hours with the Academic Consulting Team</p>
        <p>Session 2 - 4/21/2025: Lab/office hours with the Academic Consulting Team</p>
        </div>
    );
  }
